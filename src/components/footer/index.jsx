...
function Footer() {
  ...
  return (
    <div className="bg-black py-10 text-white flex  justify-center items-center">
      <div className="w-[75%] sm:w-[90%] md:w-[90%] xs:w-[90%] lg:w-[80%] xl:w-[80%] flex sm:flex-col xs:flex-col sm:ml-6 xs:ml-6 flex-row justify-between gap-6 ">
        <section className="flex flex-col gap-2 flex-1 ">
          <h2 className="  inline font-medium md:text-sm ">
            LIÊN HỆ CHÚNG TÔI
          </h2>
        ...
        <section className="flex flex-col gap-2 flex-1 ">
          <h2 className=" inline font-medium md:text-sm">LIÊN KẾT</h2>
          <div className="border-2 w-[30%] mb-2"></div>

          <div className=" flex flex-col gap-2 md:text-sm text-gray-400">
            <Link
              to={"/"}
        ...
        <section className="flex flex-col gap-2 flex-1 ">
          <h2 className=" inline font-medium md:text-sm">DANH MỤC SẢN PHẨM</h2>
          <div className="border-2 w-[30%] mb-2"></div>

          <div className=" flex flex-col gap-2 md:text-sm text-gray-400">
            {categorys?.map((item) => (
              <span
                className=" hover:underline hover:underline-offset-2 cursor-pointer hover:text-red-600"
                key={item?._id}
              >
                {item?.value}
              </span>
        ...
        <section className="flex flex-col gap-2 flex-1 ">
          <h2 className=" inline font-medium md:text-sm">FANPAGE FACEBOOK</h2>
          <div className="border-2 w-[30%] mb-2"></div>

          <div className=" flex flex-col gap-2 text-gray-400 md:text-sm">
